          ...
          <Container className="bg-white rounded-lg p-[40px] max-w-[660px] text-black">
            ...
            <Section>
              ...
              <Text className="text-base">
                We wanted to inform you that your permissions in our shop (
                <span className="font-semibold">Flower Shop</span>) have been
                completely deleted and have no access in our shop.
              </Text>
              <Text className="text-base">
