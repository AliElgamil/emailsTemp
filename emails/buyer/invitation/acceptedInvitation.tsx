          ...
          <Container className="bg-white rounded-lg p-[40px] max-w-[660px] text-black">
            ...
            <Section>
              ...
              <Text className="text-base">
                We’re thrilled to welcome you as a manager to (
                <span className="font-semibold">Flower Shop</span>) get ready
                for special permissions
              </Text>
              <Text className="text-base">
                You can now explore the Permissions such as (create product ,
                update products, .....etc){" "}
