...
export default function InvitationJoinShop() {
  return (
    <Html>
      <Head />
          ...
          <Container className="bg-white rounded-lg p-[40px] max-w-[660px] text-black">
            ...
            <Section>
              ...
              <Text className="text-base">
                We’re excited to let you know that you have been invited to join
                our shop (<span className="font-semibold">Flower Shop</span>) We
                can’t wait for you to be part of our community and look forward
                to providing you with the best experience.
              </Text>
              <Text className="text-base">
                If you have any questions or need more information about what we
                offer, please{" "}
